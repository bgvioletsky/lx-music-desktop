#!/bin/bash
kk=$1
url="https://tiku.fenbi.com/activity/userquiz/updateUserQuestionInfo?sheetType=151&questionCount=${kk}&yearScope=0&correctRatioLow=0&correctRatioHigh=1&app=web&kav=100&av=100&hav=100&version=3.0.0.0"
